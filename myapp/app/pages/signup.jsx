...
import ApplyReferralPopup from '../../components/referal';
...
const Signup = () => {
    ...
    return (
        <ImageBackground source={require('../../assets/images/auth.png')} style={styles.background} resizeMode="cover">
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'} >
                <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                    ...
                    <SafeAreaView style={styles.overlay}>
                        ...
                        <Text style={styles.subtitle}>Join our car rental service</Text>
            ...
            <ApplyReferralPopup visible={openPopup} onClose={() => { setOpenPopup(false); router.replace("/pages/login"); }}
                onSuccess={() => { setOpenPopup(false); router.replace("/pages/login"); }}
            />
        </ImageBackground>
    );
};
