...
import { connectWs } from '../../hooks/socket';
import { removeChatuser, setChatuser } from '../../features/chatuserSlice';
...
const Chat = () => {
  ...
  const senderName = useSelector(state => state.chatuser.chatuser);
